package com.gaspersoft.businvoice.utils;
...
public class PrintHelper {
    ...
    private static PrintHelper helper = new PrintHelper();
    ...
    public void printColumnsString(String[] txts, int[] width, int[] align, boolean isBold) {
        if (sunmiPrinterService == null) {
            //TODO Service disconnection processing
            return;
        }
    ...
    public void showPrinterStatus(Context context) {
        ...
        try {
            ...
            switch (res) {
                case 1:
                    result = "La impresora está funcionando";
                    break;
                case 2:
                    result = "Impresora encontrada pero aún inicializándose";
                    break;
                case 3:
                    result = "La interfaz del hardware de la impresora es anormal y debe reimprimirse";
                    break;
                case 4:
                    result = "La impresora no tiene papel";
                    break;
                case 5:
                    result = "La impresora se sobrecalienta";
                    break;
                case 6:
                    result = "La tapa de la impresora no está cerrada";
                    break;
                case 7:
                    result = "El cortador de la impresora es anormal";
                    break;
                case 8:
                    result = "El cortador de la impresora es normal";
                    break;
                case 9:
                    result = "Papel de marca negra no encontrado";
                    break;
                case 505:
                    result = "La impresora no existe";
                    break;
                default:
                    break;
            }
